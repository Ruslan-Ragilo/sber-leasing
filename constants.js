export const DataMap = [
  ...
  },
  {
    ...
    position: 'Директор филиала',
    congratsText:
      '«От всей души поздравляю команду СберЛизинга с 30-летием! <br> <br> Желаю каждому сотруднику самореализации, желания расти вместе с компанией, получать только положительные эмоции от каждого прожитого дня, находить время для своих близких людей.Я счастлив работать в команде единомышленников! Процветания компании и каждому сотруднику!»',
    foundationYear: '2010',
    employeesNumber: '70',
    menWomen: ['40', '60'],
    clients: '2258',
  ...
  },
  {
    ...
    position: 'Директор филиала',
    congratsText:
      '«Уважаемые партнёры и коллеги! Поздравляю вас с 30-летием компании! <br><br> СберЛизинг видит своей миссией помогать клиентам достигать целей любого масштаба и обеспечивать удобный сервис и долгосрочное партнёрство. Наша команда благодрит клиентов за доверие!»',
    foundationYear: '2004',
    employeesNumber: '82',
    menWomen: ['48', '52'],
    clients: '2979',
  ...
  },
  {
    ...
    position: 'Директор филиала',
    congratsText:
      '«Поздравляю с 30-летним юбилеем всех клиентов и сотрудников СберЛизинга. <br><br> Пусть клиентам всегда будет с нами легко и комфортно —мы ежедневно делаем все от нас зависящее, чтобы именно так и было! А всей нашей большой и дружной команде лучшей лизинговой компании страны — здоровья, радости и удовольствия от жизни и работы. <br><br> Вперед к новым рекордам!»',
    foundationYear: '2019',
    employeesNumber: '95',
    menWomen: ['60', '40'],
    clients: '2779',
  ...
  },
  {
    ...
    position: 'Директор филиала',
    congratsText:
      '«Поздравляю с Днём рождения наш любимый СберЛизинг! Я желаю достижения всех наших амбициозных целей, лидерских позиций в рейтингах, сплоченной, целеустремленной команды и довольных, счастливых клиентов! <br><br> А нашим дорогим клиентам я желаю процветания в бизнесе, совместных крутых проектов и долголетнего плодотворного сотрудничества!»',
    foundationYear: '2002',
    employeesNumber: '82',
    menWomen: ['33', '67'],
    clients: '3023',
  ...
  },
  {
    ...
    position: 'Директор филиала',
    congratsText:
      '«От имени коллектива Байкальского регионального филиала и от себя лично поздравляю всех сотрудников СберЛизинга с 30-летним юбилеем! <br><br> Поздравляю не просто сотрудников, а команду профессионалов, способных справиться с любыми задачами! <br><br> Хочется пожелать благополучия, полноты сил для достижения новых целей, уверенности в завтрашнем дне и надёжных партнеров!»',
    foundationYear: '2010',
    employeesNumber: '51',
    menWomen: ['38', '62'],
    clients: '2046',
...
export const ImagesInfo = [
    ...
    {name: 'i_5_1', position: [-0.57, -1.0, -12.4], scale: 1.5, fadeInStartPosition: -11.8},
    {name: 'i_5_2', position: [0.795, -1.00, -13.697], scale: 1.5, fadeInStartPosition: -11.8},
    {name: 'i_5_3', position: [0.115, 1.0, -10.6], scale: 0.09, fadeInStartPosition: -11.8},
    {name: 'i_5_4', position: [0.145, 1.0, -10.73], scale: 0.07, fadeInStartPosition: -11.8},
    {name: 'i_6', position: [-0.2, 0.5, -9.795], scale: 1.2, fadeInStartPosition: -11},
    {name: 'i_7_b', position: [-0.047, -1.0, -9.9], scale: 1.0, fadeInStartPosition: -9},
    {name: 'i_7_t', position: [-0.047, 1.0, -7.1], scale: 1.0, fadeInStartPosition: -9},
    {name: 'i_8_b', position: [-0.32, 0, -7.15], scale: 1.1, fadeInStartPosition: -7.5},
    {name: 'i_8_t', position: [0.40, 0, -6.5], scale: 0.7, fadeInStartPosition: -6.9},
    {name: 'i_9_b', position: [-0.75, 0, -4.52], scale: 1.8, fadeInStartPosition: -4.7},
    {name: 'i_9_t', position: [0.65, 0, -3.65], scale: 2.0, fadeInStartPosition: -4.3},
    {name: 'i_10', position: [-0.3, 0, -2.8], scale: 0.6, fadeInStartPosition: -2.8},
    {name: 'i_11_b', position: [-0.5, 0, -1.46], scale:  1.4, fadeInStartPosition: -1.4},
    {name: 'i_11_t', position: [0.21, 1, 0.67], scale: 0.965, fadeInStartPosition: -1.4},
