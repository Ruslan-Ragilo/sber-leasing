export const DataMap = [
  ...
  },
  {
    ...
    congratsText:
      '«Дорогие клиенты и сотрудники СберЛизинга! <br><br> На протяжении уже очень многих лет мы с вами сообща решаем самые разные задачи — и справедливо наш 30-летний юбилей тоже считать совместным! <br><br> Мы искренне рады, что наше сотрудничество помогает развитию вашего бизнеса, и гордимся результатами партнерства. Всем сотрудникам СберЛизинга желаю развития карьеры, профессионального роста, нового опыта и новых знаний!»',
    foundationYear: '2009',
    employeesNumber: '59',
    menWomen: ['53', '47'],
    clients: '2144',
  ...
  },
  {
    ...
    position: 'Директор филиала',
    congratsText:
      '«Поздравляю всех с юбилеем нашей замечательной компании! <br><br> Хочу пожелать СберЛизингу долгих лет стабильного успеха, уверенной деятельности, неугасаемого процветания. Пусть каждый год успешной работы выводит нашу компанию на более высокий уровень. Всем сотрудникам — здоровья и крепких сил, высокого профессионализма, счастья и благополучия. И всем нам только довольных клиентов и масштабных проектов!»',
    foundationYear: '2010',
    employeesNumber: '82',
    menWomen: ['54', '46'],
    clients: '3224',
